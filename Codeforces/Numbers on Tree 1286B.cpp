...
Sacar la lista en orden de los vertices a los que
se les deben asignar los enteros de 1 a n y meter el padre
de todos esos en la posicion c[u] de la lista para cada nodo
*/
